...
void SensorHandler::setup_rtc() {
  ...
  LOG_FILE += String(timestamp.year(), DEC) + "_" +
              String(timestamp.month(), DEC) + "_" +
              String(timestamp.day(), DEC) + "__";
  LOG_FILE += String(timestamp.hour(), DEC) + "_" +
              String(timestamp.minute(), DEC) + "_" +
              String(timestamp.second(), DEC) + ".csv";
...
double SensorHandler::getWindSpeedData() {
  ...
  if (voltage <= VOLTAGE_MIN) {
    ...
    wind_speed = ((voltage - VOLTAGE_MIN) * (MAX_SPEED - MIN_SPEED) /
...
DateTime SensorHandler::getDateTime() { return rtc.now(); }
void SensorHandler::write_sd() {
  ...
  data_to_print += String(timestamp.year(), DEC) + "/" +
                   String(timestamp.month(), DEC) + "/" +
                   String(timestamp.day(), DEC) + " ";
  data_to_print += String(timestamp.hour(), DEC) + ":" +
                   String(timestamp.minute(), DEC) + ":" +
                   String(timestamp.second(), DEC) + ", ";
